...
ok(
    "local_rendezvous_read_only_services",
    "if env.service not in {" in runtime
    and '"storage.summary",' in runtime
    and '"master.status",' in runtime
    and "local relay permits approved read-only services only" in runtime,
)
