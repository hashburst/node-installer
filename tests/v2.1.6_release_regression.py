...
ok('checklist_field_gate_passed', 'Status: RELEASE CANDIDATE' in checklist)
...
ok('v216_restores_registered_peer_superset', 'restored registered peer' in runtime and '_reconcile_registered_peers' in runtime)
ok('v216_preserves_nat_coordinates', 'never overwrite NAT coordinates' in runtime or 'preserve' in runtime.lower())
